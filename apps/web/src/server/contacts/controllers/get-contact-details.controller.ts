...
import { ContactDetailsDTO } from '@/shared/dtos/contact.dto'
import { UserDTO } from '@/shared/dtos/user.dto'
import { ForbiddenError } from '@/shared/errors'

export async function getContactDetailsController(
    contactId: string,
    ...
    const contact = await contactsReadRepo.getContactDetails(
